...
const placeholderLinks = [
  { label: "Next Event: TBD", href: "/events" },
  { label: "Join Our Newsletter", href: "https://dcmovieclub.substack.com" },
      ...
      <div className="mt-4 flex w-full flex-col gap-3">
        {placeholderLinks.map((link) => (
          <a
            key={link.href}
            href={link.href}
            className="block w-full rounded border border-border px-4 py-3 text-center uppercase tracking-wide transition-colors hover:border-primary hover:text-primary"
          >
            {link.label}
          </a>
        ))}
